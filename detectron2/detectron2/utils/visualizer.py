...
class Visualizer:
    ...
    def draw_dataloader(self, predictions):
            """
            ...
            scores = predictions.gt_classes if predictions.has("gt_classes") else None
            ...
            #print(f"The initial keypoints are {keypoints}")
            masks=predictions.gt_masks if predictions.has("gt_masks") else None
    ...
    def overlay_instances(
        ...
        *,
        ...
        """
        num_instances = None
        #print(f"Passed key Points are {keypoints}")
        ...
        if self.metadata.get("keypoint_connection_rules"):
            for kp0, kp1, color in self.metadata.keypoint_connection_rules:
                if kp0 in visible and kp1 in visible:
                    ...
                    self.draw_text("Head",[x0, y0], color=color)
                    self.draw_text("Tail",[x1, y1], color=color)
