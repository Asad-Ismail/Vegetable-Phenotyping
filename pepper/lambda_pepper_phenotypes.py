...
if __name__==__name__:
    # mask and fruit patch are binary and RGB detected fruit patch. Mask and fruit should be orientation corrected along x axis
    image_name="corrected_021XZ2418_210715_124212_719242_001.jpg"
    mask=cv2.imread(os.path.join("/home/asad/test_patch/",image_name),-1)
